...
export JAVA_STATIC=/home/johan/openjdk/mobile/fork/mobile/build/android-aarch64-server-release/images/static-libs/lib/
...
$compiler -target $platform -c -o graalobj/JvmFuncs.o  src/native/JvmFuncs.c 
...
$compiler -target $platform -fPIC -Wl,--gc-sections -o lib/arm64-v8a/libmygraal.so  -L$JAVA_STATIC -Lbinariesfornow \
  -landroid -llog -lz -lstrictmath -lGLESv2 -lEGL -shared  \
  -Wl,--whole-archive binariesfornow/hello.helloworld.o binariesfornow/llvm.o -Wl,--no-whole-archive graalobj/StrictMath.o graalobj/JvmFuncs.o graalobj/graallauncher.o graalobj/glass_android.o -ljava -lnio -lzip
